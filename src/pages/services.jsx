    ...
    return (
        <main>
            ...
            <section className="services-section">
                <div className="card" >
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-brush services-svg" viewBox="0 0 16 16">
                ...
                <div className="card" >
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-code-slash services-svg" viewBox="0 0 16 16">
